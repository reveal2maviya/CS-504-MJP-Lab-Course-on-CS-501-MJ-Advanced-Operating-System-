...
void sigquit_handler(int signum) {
    printf("Child received SIGQUIT signal from parent and is terminating: My Papa has Killed me!!!\n");
    exit(0);
}
...
//    Example: gcc program.c -o signal_handling_example
// 3. Run the compiled program.
// 4. The child process will catch and handle the specified signals as instructed in the code.
...
int main() {
    ...
    if (child_pid == 0) {
        ...
        // Send SIGQUIT to the child process after 15 seconds
